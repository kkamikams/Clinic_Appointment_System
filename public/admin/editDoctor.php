...
$doc = $doctorModel->getDoctorById($id);
...
$specs = ['General Medicine', 'Cardiology', 'Pediatrics', 'Dermatology', 'OB-GYN'];
$depts = ['General', 'Internal Medicine', 'Child Health', 'Skin & Hair', 'Maternal Care'];
            ...
            <form id="editDoctorForm" onsubmit="saveDoctor(event)">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <select name="specialization" onchange="updateSidebar(); syncDepartment(this.value)">
...
<script>
    ...
    function syncDepartment(spec) {
        const dept = document.querySelector('[name="department"]');
        if (SPEC_TO_DEPT[spec]) dept.value = SPEC_TO_DEPT[spec];
    }
